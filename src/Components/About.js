       ...
       <div class="about-us mt-5" id="about">
        ...
        <div class="row mt-5">
          <div class="col-lg-7 p-lg-5">
            ...
            <button type="button" class="btn btn-danger btn-lg mx-lg-5 mt-4">Get Started <i class="fa fa-arrow-right" aria-hidden="true"></i></button>
            </div>
